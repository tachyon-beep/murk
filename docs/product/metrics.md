...
| Cargo deny advisories | 0 unreviewed advisory failures | Main CI passes with temporary ignores for `RUSTSEC-2026-0176` and `RUSTSEC-2026-0177` until rust-numpy publishes a `pyo3 0.29`-compatible release; `rand` lockfile updated to `0.8.6` for `RUSTSEC-2026-0097` | 2026-06-12 |
