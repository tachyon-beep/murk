...
class StepMetrics:
    ...
    @property
    def sparse_retired_ranges(self) -> int: ...
    @property
    def sparse_pending_retired(self) -> int: ...
    @property
    def sparse_reuse_hits(self) -> int: ...
    @property
    def sparse_reuse_misses(self) -> int: ...
    @property
    ...
    @property
    def ring_eviction_events(self) -> int: ...
    @property
    def ring_stale_read_events(self) -> int: ...
    @property
    def ring_skew_retry_events(self) -> int: ...
